...
API REST desenvolvida com **Spring Boot** para o gerenciamento de pessoas, com operações CRUD completas e banco de dados **Oracle** rodando em um container **Docker** em uma **VM na Azure**.
...
3. **Configure o banco de dados**
   Edite o arquivo `src/main/resources/application.properties` com os seguintes parâmetros:
...
4. **Build e execução**
   ...
   A aplicação estará disponível em: [20.63.43.37:8080](l20.63.43.37:8080)
...
* Em VMs com pouca memória (como no **free tier** da Azure), recomenda-se rodar o Gradle com `--no-daemon` e limitar o **heap da JVM**.
